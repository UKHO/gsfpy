...
import gsfpy3_08.bindings
import gsfpy3_08.enums
from gsfpy3_08.constants import GSF_MAX_PING_ARRAY_SUBRECORDS
from gsfpy3_08.enums import (
    FileMode,
    PingFlag,
    RecordType,
...
from gsfpy3_08.GSF_POSITION import c_GSF_POSITION
from gsfpy3_08.GSF_POSITION_OFFSETS import c_GSF_POSITION_OFFSETS
from gsfpy3_08.gsfDataID import c_gsfDataID
from gsfpy3_08.gsfMBParams import c_gsfMBParams
from gsfpy3_08.gsfRecords import c_gsfRecords
from gsfpy3_08.gsfScaleFactors import c_gsfScaleFactors
from gsfpy3_08.gsfSwathBathyPing import c_gsfSwathBathyPing


def test_gsfOpenClose_success(gsf_test_data_03_08):
    """
...
def test_gsfOpenBuffered_success(gsf_test_data_03_08):
    """
    Open the test GSF file, then close.
    """
    file_handle = c_int(0)
    ...
    return_value = gsfpy3_08.bindings.gsfOpenBuffered(
        os.fsencode(str(gsf_test_data_03_08.path)),
        FileMode.GSF_READONLY,
        byref(file_handle),
        buf_size,
...
def test_gsfSeek_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfSeek(file_handle, SeekOption.GSF_END_OF_FILE)
    assert_that(return_value).is_zero()
...
def test_gsfError_non_existent_file(gsf_test_data_03_08):
    """
...
def test_gsfError_operation_in_wrong_file_mode(gsf_test_data_03_08):
    ...
    return_value = gsfpy3_08.bindings.gsfGetNumberRecords(
...
def test_gsfRead_success(gsf_test_data_03_08):
    """
...
def test_gsfGetNumberRecords_success(gsf_test_data_03_08):
    """
    ...
    number_of_records = gsfpy3_08.bindings.gsfGetNumberRecords(
        file_handle, RecordType.GSF_RECORD_SWATH_BATHYMETRY_PING
    )
...
def test_gsfIndexTime_success(gsf_test_data_03_08):
    """
    ...
    index_time = gsfpy3_08.bindings.gsfIndexTime(
        file_handle,
...
def test_gsfPercent_success(gsf_test_data_03_08):
    """
    ...
    for i in range(4):
        gsfpy3_08.bindings.gsfRead(
            file_handle, RecordType.GSF_NEXT_RECORD, byref(data_id), byref(records)
        )

    percent = gsfpy3_08.bindings.gsfPercent(file_handle)
...
def test_gsfGetSwathBathyBeamWidths_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfGetSwathBathyBeamWidths(
...
def test_gsfGetSwathBathyArrayMinMax_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfGetSwathBathyArrayMinMax(
...
def test_gsfIsStarboardPing_success(gsf_test_data_03_08):
    """
    ...
    is_starboard_ping: int = gsfpy3_08.bindings.gsfIsStarboardPing(byref(records))
...
def test_gsfGetSonarTextName_success(gsf_test_data_03_08):
    """
    ...
    sonar_text_name = gsfpy3_08.bindings.gsfGetSonarTextName(byref(records.mb_ping))
...
def test_gsfFileSupportsRecalculateXYZ_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfFileSupportsRecalculateXYZ(
...
def test_gsfFileSupportsRecalculateTPU_success(gsf_test_data_03_08):
    """
    Open the test GSF file then discover whether it contains enough information
    ...
    return_value = gsfpy3_08.bindings.gsfFileSupportsRecalculateTPU(
        file_handle, byref(status)
    )
    assert_that(return_value).is_zero()
...
def test_gsfFileSupportsRecalculateNominalDepth_success(gsf_test_data_03_08):
    """
    Open the test GSF file then discover whether it contains enough information
    ...
    return_value = gsfpy3_08.bindings.gsfFileSupportsRecalculateNominalDepth(
        file_handle, byref(status)
    )
    assert_that(return_value).is_zero()
...
def test_gsfFileContainsMBAmplitude_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfFileContainsMBAmplitude(
        file_handle, byref(status)
    )
    assert_that(return_value).is_zero()
...
def test_gsfFileContainsMBImagery_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfFileContainsMBImagery(
        file_handle, byref(status)
    )
    assert_that(return_value).is_zero()
...
def test_gsfFileIsNewSurveyLine_success(gsf_test_data_03_08):
    """
    ...
    is_new_survey_line: int = gsfpy3_08.bindings.gsfIsNewSurveyLine(
...
def test_gsfInitializeMBParams_success(gsf_test_data_03_08):
    """
    ...
    # Act
    gsfpy3_08.bindings.gsfInitializeMBParams(byref(mbparams))
...
def test_gsfCopyRecords_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfCopyRecords(
...
def test_gsfPutMBParams_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfPutMBParams(
...
def test_gsfGetMBParams_success(gsf_test_data_03_08):
    """
    ...
    gsfpy3_08.bindings.gsfInitializeMBParams(byref(mbparams_in))
    mbparams_in.horizontal_datum = c_int(57)

    mbparams_out = c_gsfMBParams()
    gsfpy3_08.bindings.gsfInitializeMBParams(byref(mbparams_out))
    ...
    return_value = gsfpy3_08.bindings.gsfGetMBParams(
...
def test_gsfStat_success(gsf_test_data_03_08):
    """
    ...
    # Act
    return_value = gsfpy3_08.bindings.gsfStat(
        os.fsencode(str(gsf_test_data_03_08.path)), byref(sz)
    )
    assert_that(return_value).is_zero()
...
def test_gsfLoadScaleFactor_success(gsf_test_data_03_08):
    """
    ...
    # Act
    return_value = gsfpy3_08.bindings.gsfLoadScaleFactor(
...
def test_gsfGetScaleFactor_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfGetScaleFactor(
...
def test_gsfSetDefaultScaleFactor_success(gsf_test_data_03_08):
    """
    ...
    return_value = gsfpy3_08.bindings.gsfSetDefaultScaleFactor(byref(records.mb_ping))
    assert_that(return_value).is_zero()
...
def test_gsfLoadDepthScaleFactorAutoOffset_success(gsf_test_data_03_08):
    """
...
def test_gsfGetPositionDestination(gsf_test_data_03_08):
    """
    ...
    # Act
    position_destination = gsfpy3_08.bindings.gsfGetPositionDestination(
...
def test_gsfGetPositionOffsets(gsf_test_data_03_08):
    """
    ...
    # Act
    position_offsets = gsfpy3_08.bindings.gsfGetPositionOffsets(
...
def test_gsfTestPingStatus(gsf_test_data_03_08):
    """
    ...
    # Act
    set_ping_status = gsfpy3_08.bindings.gsfTestPingStatus(
        c_ushort(mb_ping.ping_flags), c_ushort(PingFlag.GSF_PING_USER_FLAG_05)
    )
    unset_ping_status = gsfpy3_08.bindings.gsfTestPingStatus(
...
def test_gsfSetPingStatus(gsf_test_data_03_08):
    """
    ...
    # Act
    new_ping_status = gsfpy3_08.bindings.gsfSetPingStatus(
        c_ushort(mb_ping.ping_flags), c_ushort(PingFlag.GSF_PING_USER_FLAG_15)
    )
...
def test_gsfClearPingStatus(gsf_test_data_03_08):
    """
    ...
    # Act
    new_ping_status = gsfpy3_08.bindings.gsfClearPingStatus(
