...
TIME_SERIES_INTENSITY_SPARE_BYTES = c_ubyte * 6
...
KMALL_SPARE = c_ubyte * 64

class c_gsfKMALLImagerySpecific(Structure):
    _fields_ = [
        ("spare", KMALL_SPARE),
    ]
...
class c_gsfSensorImagery(Union):
    _fields_ = [
        ...
        ("gsfKMallImagerySpecific", c_gsfKMALLImagerySpecific),
    ]
