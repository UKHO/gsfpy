...
def mirror_default_gsf_version_submodule(_globals: dict, submodule_name: str = None):
    ...
    Params:
        _globals: the dictionary of globals pertaining to the calling module. This can
                  be obtained with a call to globals(). This is required as the globals
                  dictionary is updated by the call to the function.
    ...
    gsf_submodule = __import__(gsf_submodule_name, _globals, None, ["*"], 0)
